...
class ContextStringifierTest extends \PHPUnit_Framework_TestCase {
	...
	public function test_ArrayValue_stringifyArray_ShouldStringifyArrayValues() {
		...
		$this->assertEquals(print_r($objectWithoutToString, true), $stringifiedContext['array']['objectWithoutToString']);
		...
		$this->assertEquals($objectWithToString->__toString(), $stringifiedContext['array']['nested array']['nested objectWithToString']);
		$this->assertEquals(print_r($objectWithoutToString, true), $stringifiedContext['array']['nested array']['nested objectWithoutToString']);
	}
